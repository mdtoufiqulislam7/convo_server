  ...
  try {
    ...
    if (parseInt(productCheck.rows[0].count, 10) === 0) {
      ...
      const productsData = [
        ...
        ['আখের লাল চিনি (Organic Red Cane Sugar)', 250.00, 'আমাদের সুন্নাহ ফুড বিডি তে পেয়ে যাবেন আখের লাল চিনি। এটি ১০০% অর্গানিক এবং ভেজাল মুক্ত। মূল্য: ২৫০ টাকা প্রতি কেজি।', 'in_stock', ['আখের লাল চিনি', 'আখের চিনি', 'লাল চিনি', 'চিনি', 'অর্গানিক চিনি', 'red sugar', 'cane sugar', 'sugar', 'akher chini', 'lal chini', 'chini']],
        ['ফ্রেশ পেস্তা বাদাম (Fresh Pistachio Nuts)', 2850.00, 'দুবাই থেকে নিয়ে আসলাম ফ্রেশ পেস্তা বাদাম। মূল্য: ২৮৫০ টাকা প্রতি কেজি।', 'in_stock', ['পেস্তা বাদাম', 'পেস্তাবাদাম', 'পেস্তা', 'বাদাম', 'দুবাই পেস্তা বাদাম', 'pistachio', 'pistachio nuts', 'pesta badam', 'badam', 'nuts']]
      ];
